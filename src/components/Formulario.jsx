...
const Formulario = ({pacientes, setPacientes, paciente, setPaciente}) => {
   ...
   const generarId = ( () => {
    ...
    const handleSubmit = (e) => {
        ...
        //Validacion
        if ([nombre, propietario, telefono, email, fecha, sintomas].includes('') ) {
            setError(true)
            return;
        } 
        ...
        <div className="md:w-1/2 lg:w-2/5 mx-5">
            ...
            >
                ...
                <input 
                    ...
                    // Ternario - Condicional para cambiar texto
                    value={ paciente.id ? "Editar Paciente" : "Agregar Paciente"}
                    //
                />

                { error && <Error mensaje='Todos los cmapos son obligatorios' />
                }
            </form>
        </div>
    )
